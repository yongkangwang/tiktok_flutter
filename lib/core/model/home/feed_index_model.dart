...
AKFeedIndexModel hyAccountMineModelFromJson(String str) =>
    AKFeedIndexModel.fromJson(json.decode(str));

class AKFeedIndexModel {
  AKFeedIndexModel({
    required this.code,
  ...
  factory AKFeedIndexModel.fromJson(Map<String, dynamic> json) =>
      AKFeedIndexModel(
        code: json["code"],
