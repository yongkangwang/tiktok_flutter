...
//
//     final CartoonModel = cartoonModelFromJson(jsonString);

import 'dart:convert';

AkCartoonModel? cartoonModelFromJson(String str) =>
    AkCartoonModel.fromJson(json.decode(str));

String cartoonModelToJson(AkCartoonModel? data) =>
    json.encode(data!.toJson());

class AkCartoonModel {
  AkCartoonModel({
    this.code,
    this.message,
    this.result,
  ...
  factory AkCartoonModel.fromJson(Map<String, dynamic> json) =>
      AkCartoonModel(
        code: json["code"],
